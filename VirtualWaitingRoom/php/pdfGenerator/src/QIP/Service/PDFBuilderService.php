...
{
    CONST PDF_ROOT_DIR = __DIR__ . '/../../../pdf-reports';
    CONST LATEX_MARKUP_DIR = __DIR__ . '/../Resources/latex-markup';
    CONST LATEX_MARKUP_FILE = 'report.tex';
    CONST LATEX_FORMAT_FILE = 'report.fmt';
    CONST LATEX_JOBNAME = 'report';
    CONST LATEX_LINE_NUMBER = 42;
     ...
     */
    public function buildPDF($patientId,
                             $patientName,
                             $patientMRN,
     ...
     * @param string $chartImagesTimestampDir
     */
    private function createAuxiliaryFilesForLatex(array $questionnaireAnswers,
                                                  $patientName,
                                                  $patientMRN,
                                                  $dirPath,
                                                  $chartImagesTimestampDir)
    {
        ...
        foreach ($questionnaireAnswers as $questionnaireKey => $questionnaire) {
            foreach ($questionnaire['questions'] as $questionKey => $question) {
                ...
                else if ($question['question_type_id'] == HighchartsServerService::TEXT_TYPE_QUESTION) {
                    //text questions
                    $textAnswerValues = "{";
        ...
        copy(PDFBuilderService::LATEX_MARKUP_DIR . "/" . PDFBuilderService::LATEX_MARKUP_FILE,
