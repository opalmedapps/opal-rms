...
app.controller('main', function($scope,$uibModal,$http,$filter,$mdDialog,$interval,$cookies,$window,DTOptionsBuilder,callScript,bowser,WearableChartsService)
{
        ...
        var modalInstance = $uibModal.open(
            {
                ...
                resolve:
                    {
                        patient: function() {return {'LastName': appoint.lname, 'FirstName': appoint.fname, 'PatientId': appoint.patientId, 'Mrn': appoint.mrn,'Site': appoint.site,'Age': appoint.age,'Sex': appoint.sex, 'QStatus': appoint.QStatus,'LastQuestionnaireReview':appoint.LastReview,};},
    ...
    $scope.openLegendDialog = function()
    {
        var legend = $mdDialog.confirm(
            {
                templateUrl: 'VirtualWaitingRoom/js/vwr/templates/legendDialogClinicalViewer.htm'
            })
