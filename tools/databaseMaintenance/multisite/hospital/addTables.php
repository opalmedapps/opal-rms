...
function createHospitalTable(PDO $dbh): void
{
    $dbh->query("
...
function createPatientHospitalIdentifierTable(PDO $dbh): void
{
    $dbh->query("
...
function createInsuranceTable(PDO $dbh): void
{
    $dbh->query("
...
function createPatientInsuranceIdentifierTable(PDO $dbh): void
{
    $dbh->query("
